...
```bash
cd {STELLAR_CONTRACTS_REPO_PATH}
...
- Mentally (or actually) run through each contract type the Wizard supports and confirm the generated output matches the new `stellar-contracts` API
